...
namespace MedicalTourismApp.Areas.Identity.Pages.Account.Forms
{
    ...
    public class RegisterHospitalModel : PageModel
    {
        ...
        public RegisterHospitalModel(ApplicationDbContext context, IConfiguration configuration ,UserManager<User> userManager ,SignInManager<User> signInManager)
        {
            _context = context;
