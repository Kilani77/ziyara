...
namespace MedicalTourismApp.Controllers
{
    ...
    public class AltController : Controller
    {
        ...
        public AltController(UserManager<User> usermanger, ISubscriptionService subscriptionService, RoleManager<IdentityRole> roleManager, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> editd(string fullname, string location, string experience, string price, string email, string lanaguage, string ava, IFormFile image)
        {
            ...
            var doctor = await _context.Freelancers
        ...
        public async Task<IActionResult> Available()
        {
            ...
            ViewBag.name = await _context.Freelancers.Where(p => p.ServiceProviderId == serviceid.Id).Select(p => p.ServiceProvider.User.FullName).FirstOrDefaultAsync();
